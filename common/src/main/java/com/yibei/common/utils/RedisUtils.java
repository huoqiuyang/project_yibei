...
public class RedisUtils {
    ...
    public static <T> void setCacheMap(final String key, final Map<String, T> dataMap, final Integer timeout, final TimeUnit timeUnit) {
        if (dataMap != null) {
            RMap<String, T> rMap = client.getMap(key);
            rMap.putAll(dataMap);
            rMap.expire(timeout, timeUnit);
        }
    }
