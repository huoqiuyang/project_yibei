...
public interface ICloudStorageStrategy {
	 ...
	 * @return 返回上传路径
	 */
	String getPath(String prefix, String suffix,String cate);
	 ...
	 * @return 返回http地址
	 */
	UploadResult uploadSuffix(byte[] data, String suffix, String contentType,String cate);
	 ...
	 * @return 返回http地址
	 */
	UploadResult uploadSuffix(InputStream inputStream, String suffix, String contentType,String cate);
