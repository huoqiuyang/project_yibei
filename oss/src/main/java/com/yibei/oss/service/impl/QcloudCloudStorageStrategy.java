package com.yibei.oss.service.impl;

import com.yibei.common.utils.StringUtils;
import com.yibei.oss.exception.OssException;
...
import com.yibei.oss.enumd.CloudServiceEnumd;
import com.yibei.oss.service.abstractd.AbstractCloudStorageStrategy;
...
public class QcloudCloudStorageStrategy extends AbstractCloudStorageStrategy {
	...
	@Override
	public com.yibei.oss.entity.UploadResult upload(byte[] data, String path, String contentType) {
		return upload(new ByteArrayInputStream(data), path, contentType);
	}

	@Override
	public com.yibei.oss.entity.UploadResult upload(InputStream inputStream, String path, String contentType) {
		try {
		...
		return new com.yibei.oss.entity.UploadResult().setUrl(getEndpointLink() + "/" + path).setFilename(path);
	}
	...
	@Override
	public com.yibei.oss.entity.UploadResult uploadSuffix(byte[] data, String suffix, String contentType, String cate) {
		return upload(data, getPath(properties.getPrefix(), suffix,cate), contentType);
	}

	@Override
	public UploadResult uploadSuffix(InputStream inputStream, String suffix, String contentType, String cate) {
		return upload(inputStream, getPath(properties.getPrefix(), suffix,cate), contentType);
	}
